...
def upgrade() -> None:
    ...
    VALUES
      ...
      (gen_random_uuid(), 'extract',          '智能提取',        '招标文件 AI 解析、需求分类、事实提取、评分结构化',     'llm', 'https://api.deepseek.com',         'deepseek-v4-pro',   'https://dashscope.aliyuncs.com/compatible-mode/v1', 'qwen-plus'),
