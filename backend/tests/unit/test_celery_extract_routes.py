...
def test_high_value_zero_output_with_review_keywords_needs_review() -> None:
    usage = BatchUsage(
...
def test_low_value_zero_output_without_suspected_missing_does_not_need_review() -> None:
    usage = BatchUsage(
        ...
        resolved_model="deepseek-v4-flash",
        latency_ms=1000,
        batch_quality={"has_requirements": False, "suspected_missing": False},
    )
...
def test_suspected_missing_zero_output_needs_review() -> None:
    usage = BatchUsage(
        ...
        resolved_model="deepseek-v4-flash",
        latency_ms=1000,
        batch_quality={"has_requirements": False, "suspected_missing": True},
    )
